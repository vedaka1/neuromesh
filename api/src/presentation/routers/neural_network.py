...
@model_router.get('', response_model=list[Model], summary='Get a list of available neural networks')
...
@model_router.get('/{model_name}', response_model=Model, summary='Get information about the neural network')
async def get_model(
    model_name: str,
...
@model_router.post('/response', response_model=ModelResponse, summary='Send a request to generate a text response')
...
@model_router.delete('/{model_name}', summary='Delete a neural network by name')
